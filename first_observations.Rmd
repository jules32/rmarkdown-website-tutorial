...
We'll also borrow heavily from [**RStudio's instructions for R Markdown websites**](http://rmarkdown.rstudio.com/rmarkdown_websites.html).
...
First, fork the [jules32/rmarkdown-website-tutorial](https://github.com/jules32/rmarkdown-website-tutorial) repo into your own account.  
Then, clone to your local computer using RStudio (preferred) the [Desktop App](https://desktop.github.com/), or the command line.
